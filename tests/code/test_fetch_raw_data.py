...
from src.lambda_functions.fetch_raw_data import get_monthly_url, notify, lambda_handler
...
def test_lambda_handler():
    ...
    with patch('boto3.client') as mock_boto, \
         patch('src.lambda_functions.fetch_raw_data.notify') as mock_notify, \
         patch('src.lambda_functions.fetch_raw_data.get_monthly_url') as mock_url:
        ...
        with patch.dict('os.environ', {
            'PROCESSOR_FUNCTION_NAME': 'test-function',
            'NOTIFICATION_TOPIC_ARN': 'test-arn'
        }):
